...
def stereo_rectification_calibrated():
    ...
    fs = cv2.FileStorage("calibration_params_2708.yml", cv2.FILE_STORAGE_READ)
    ...
    R1, R2, P1, P2, Q, ROI1, ROI2 = cv2.stereoRectify(calibParams['cameraMatrixLeft'], calibParams['distCoeffsLeft'], 
                                                    ...
                                                    (1920, 1080), calibParams['R'], calibParams['T'], 1, newImageSize=(1920, 1080) )
    ...
    return maps_right_cam, maps_left_cam, ROI1, ROI2